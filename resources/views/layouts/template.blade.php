  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
          <a class="navbar-brand" href="#"><i class="bi bi-bandaid"></i>Apotek App</a>
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              @if (Auth::user()->role == "admin")
              <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.order.data') }}"><i class="bi bi-clipboard2-data"></i>Data Pembelian</a>
              </li>
              @endif
              @if (Auth::user()->role == "cashier")
              <li class="nav-item">
                <a class="nav-link" href="{{ route('order.index') }}"><i class="bi bi-cart2"></i>Pembelian</a>
              </li>
              @endif
              @if (Auth::user()->role == "admin")
              <li class="nav-item">
                <a class="nav-link" href="{{ route('user.home') }}"><i class="bi bi-person-circle"></i>Kelola akun</a>
              </li>
              @endif
              <li class="nav-item">
                <a class="nav-link" href="{{route ('auth-logout')}}"><i class="bi bi-box-arrow-right"></i>logout</a>
              </li>
              @endif
